...
function createEquipmentRouter(controller) {
  ...
  router.post('/', apiKeyAuth, validate({ body: equipmentSchemas.createBody }), asyncHandler(controller.create));
  ...
  router.patch('/:id', apiKeyAuth, validate({ params: equipmentSchemas.idParams, body: equipmentSchemas.updateBody }), asyncHandler(controller.update));
  router.delete('/:id', apiKeyAuth, validate({ params: equipmentSchemas.idParams }), asyncHandler(controller.delete));
